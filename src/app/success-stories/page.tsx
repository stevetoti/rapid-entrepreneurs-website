...
export const metadata: Metadata = {
  ...
  description: 'See how Rapid Entrepreneurs has helped African businesses transform and grow through digital solutions. Real results from real businesses.',
}
    ...
    <>
      ...
      <section className="relative bg-deep-blue py-24 md:py-32">
        <div className="absolute inset-0">
          <Image src="/images/business-handshake.jpg" alt="Business partnership" fill className="object-cover opacity-15" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="heading-xl text-white mt-4 mb-6">Real Results for Real Businesses</h1>
          <p className="text-gray-300 text-xl max-w-3xl mx-auto leading-relaxed">
            Discover how we have helped African entrepreneurs and businesses transform their operations
            and achieve remarkable growth through digital solutions.
          </p>
        </div>
      </section>
            ...
            <div key={i} className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
              <div className="grid grid-cols-1 lg:grid-cols-2">
                <div className="relative h-64 lg:h-auto">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t lg:bg-gradient-to-r from-deep-blue/80 to-transparent"></div>
                ...
                <div className="p-8 md:p-12">
                  ...
                  <div className="mb-6">
                    <h4 className="font-semibold text-deep-blue mb-2">The Challenge</h4>
                    <p className="text-gray-600 leading-relaxed">{study.challenge}</p>
                  </div>

                  <div className="mb-6">
                    <h4 className="font-semibold text-deep-blue mb-2">Our Solution</h4>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                    {study.results.map((result, j) => (
                      <div key={j} className="bg-light-blue rounded-xl p-4 text-center">
                  ...
                  {/* Testimonial */}
                  <div className="bg-soft-cream rounded-xl p-6">
                    <p className="text-gray-700 italic mb-3">&ldquo;{study.testimonial.text}&rdquo;</p>
                    <div>
                      <span className="font-semibold text-deep-blue">{study.testimonial.name}</span>
