...
const SITE_ID = 'rapidentrepreneurs';
...
export async function POST(request: Request) {
  try {
    ...
    const prompt = `You are an expert SEO content writer for Rapid Entrepreneurs, a leading digital solutions company in Accra, Ghana specializing in web development, mobile apps, e-commerce, fintech, and AI solutions for African business growth.

Write a comprehensive, SEO-optimized blog article targeting the keyword: "${keyword}"

CONTEXT:
- Target audience: Entrepreneurs and businesses in Ghana and West Africa
...
- **Local Expertise**: Deep understanding of the Ghanaian and West African market
- **Global Standards**: International best practices adapted for African businesses
...
*Rapid Entrepreneurs - Empowering African Business Growth*`,
